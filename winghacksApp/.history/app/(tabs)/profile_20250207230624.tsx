...
import { ThemedView, ThemedText } from '@react-navigation/native';
...
const TabTwoScreen = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      // If login is successful, you can set the token or other user data
      setAuthToken(credentials.accessToken);
      
      // Optionally, you can retrieve user info
